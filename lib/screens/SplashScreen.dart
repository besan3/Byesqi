  ...
  void navigationToDashboard() async {
    ...
    if (getBoolAsync(isFirstTime, defaultValue: true)) {
      ...
      await getUserProfileDetails().then((res) async {
        getDetails(logRes: res, image: res.profileImage.validate()).then((value) => HomeScreen().launch(context, isNewTask: true));
        getVideoContinueWatch().then((value) => appStore.userContinueWatchData.addAll(value)).catchError(print);
      }).catchError((e) async {
