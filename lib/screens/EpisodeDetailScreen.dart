      ...
      child: SafeArea(
        child: Scaffold(
          appBar: PreferredSize(
            preferredSize: data.isPostRestricted.validate() ? Size(context.width(), kToolbarHeight) : Size(0, 60),
            child: appBarWidget(
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  if (data.file.validate().isNotEmpty && !data.isPostRestricted.validate()) ...[
                                    8.width,
                                    ClipRRect(
                                      borderRadius: BorderRadius.circular(50),
                                      child: BackdropFilter(
