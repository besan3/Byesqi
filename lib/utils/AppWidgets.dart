...
BoxDecoration boxDecoration(BuildContext context, {double radius = 2, Color color = Colors.transparent, Color bgColor = white, bool showShadow = false}) {
...
Widget button(BuildContext context, buttonText, {VoidCallback? onTap, double? width}) {
  return AppButton(
    ...
    child: Text(buttonText, style: primaryTextStyle(size: ts_normal.toInt(), color: Theme.of(context).textTheme.labelLarge!.color)),
      ...
      children: <Widget>[
        ...
        Text(
          ...
          style: primaryTextStyle(
            size: ts_tiny.toInt(),
            color: buttonTextColor == null ? Theme.of(context).textTheme.labelLarge!.color : buttonTextColor,
          ),
          overflow: TextOverflow.ellipsis,
          maxLines: 1,
...
List<LanguageDataModel> languageList() {
  return [
    ...
    LanguageDataModel(id: 2, name: 'Arabic', languageCode: 'ar', fullLanguageCode: 'ar-AR', flag: 'assets/images/flag/ic_ar.png'),
  ];
}
