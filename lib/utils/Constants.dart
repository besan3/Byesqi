...
const mDomainUrl = 'https://byesqi.com';

const app_name = "BYESQI";

const mBaseUrl = '$mDomainUrl/wp-json/';

const walk_titles = ["مرحبا بك في " + app_name, "مرحبا بك في " + app_name, "مرحبا بك في " + app_name];
const walk_sub_titles = [
  "تعلم معنا على جهازك اللوحي في أي وقت",
  "مقاطع وكورسات بجميع المجالات عربي و انجليزي مترجمة",
  "أستمتع في المشاهدة أسبوعيا يتم نشر محتوي جديد",
];

const aboutUsURL = "https://www.snapchat.com/add/flaah999";
const termsConditionURL = "$mDomainUrl/terms-of-use/";
const privacyPolicyURL = "$mDomainUrl/privacy-policy-2/";

// one signal appId
const mOneSignalAPPKey = 'a6869707-f036-4927-81a8-5ba7a080f95e';
