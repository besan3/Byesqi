        ...
        if (snap.hasData) {
          if (snap.data.validate().isNotEmpty) {
            ...
            return SplashWidget(
              ...
              child: Row(
                children: [
                  Text(language!.addAComment, style: boldTextStyle()).expand(),
                  16.width,
                  Icon(Icons.arrow_drop_down_rounded, size: 30),
                ],
        ...
        child: Stack(
          children: [
            if (commentList.isNotEmpty)
              ListView.separated(
                padding: EdgeInsets.only(left: 16, top: 54, right: 16, bottom: 70),
                  ...
                  : InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: context.scaffoldBackgroundColor,
                          boxShadow: [
                            BoxShadow(color: colorPrimary.withOpacity(0.2), blurRadius: 8.0, offset: Offset(0, -8)),
                          ],
                        ),
